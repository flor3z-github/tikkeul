...
- **HERO 카드**: 라벨 「매달 모으는 돈」 + 큰 금액(검정, §3 핵심 숫자) + 「원」. 보조 문구 "쓴 게 아니라 **다시 내 자산이 되는 돈**이에요"(강조부 primary). 그 아래 풀폭 박스 「올해 모은 돈」(연초 이후 누적, primary tint 배경).
